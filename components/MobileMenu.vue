    ...
    <template #header>
      ...
      <div class="overflow-y-auto">
        <ul class="list-none p-2 m-0">
          <li>
              <a v-ripple class="flex items-center cursor-pointer p-4 rounded text-surface-700 hover:bg-surface-100 dark:text-surface-0 dark:hover:bg-surface-800 duration-150 transition-colors p-ripple" @click="emit('profile')">
